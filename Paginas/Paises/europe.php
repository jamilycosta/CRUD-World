...
<body>
    <?php
        ...
        $sql = "SELECT Code, Name, Continent, Region FROM country WHERE Continent = 'Europe' AND Name LIKE '%$pesquisa%'";

        $dados = mysqli_query($conexao, $sql);
    ?>
<div class="container">
    <div class="row">
        <h1 class="pag-tabela">Países da Europa</h1>                 
        <nav class="navbar">
            <h4>Pesquisar por nome:</h4>
            <div class="container-fluid">
                <form class="d-flex" action="europe.php" method="POST">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col">
                <a href="../Cadastros_paises/cadastro_paisE.php" class="btn btn-success pull-right">
                            ...
                            while ($linha = mysqli_fetch_assoc($dados)) {
                                ...
                                echo 
                                    "<tr>
                                      ...
                                      <td>$continente</td>
                                      <td><center>
                                        <a href='../VerMais_paises/vermais_paisE.php?code=$codigo' class='mr-3' title='Ver Mais' data-toggle='tooltip'><span class='fa fa-eye'></span></a>
                                        <a href='../Editar_paises/editar_paisE.php?code=$codigo' class='mr-3' title='Editar Informações' data-toggle='tooltip'><span class='fa fa-pencil'></span></a>
                                        ...
                                        <a href='../Cidades/cidadesE.php?code=$codigo' class='mr-3' title='Ver Cidades' data-toggle='tooltip'><span class='fa fa-building'></span></a>
                                        <a href='../Idiomas/idiomasE.php?code=$codigo' class='mr-3' title='Ver Idiomas' data-toggle='tooltip'><span class='fa fa-language'></span></a>
                                      </center></td>
                                    </tr>";
                            }
                        ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../Scripts/Excluirpais_script/excluirpaisE_script.php" method="POST">
