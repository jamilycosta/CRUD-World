...
<div class="row justify-content-center align-items-center">
	<div class="col-6">
		<form action="../Scripts/Cadastropais_script/cadastropaisSA_script.php" method="POST">
			<div class="form-group">
	  		...
	  		<div class="mb-3">
			    ...
			    <input type="text" class="form-control" name="continent" id="continent" value="<?php echo "South America" ?>" required>
	  		</div>
	  		<div class="form-group">
