...
<div class="row justify-content-center align-items-center">
	<div class="col-6">
		<form action="../Scripts/Cadastropais_script/cadastropaisE_script.php" method="POST">
		    ...
		    <input type="text" class="form-control" name="code" id="code" required>
	  		...
	  		<div class="mb-3">
			    ...
			    <input type="text" class="form-control" name="continent" id="continent" value="<?php echo "Europe" ?>" required>
	  		</div>
	  		<div class="form-group">
