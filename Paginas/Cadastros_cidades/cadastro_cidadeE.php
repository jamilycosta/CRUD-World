...
<body>
	...
	<div class="row justify-content-center align-items-center">
		<div class="col-6">
			<form action="../Scripts/Cadastrocidade_script/cadastrocidadeE_script.php" method="POST">
			...
			<div class="return">
		      <a href="../Cidades/cidadesE.php?code=<?php echo $_GET['code']; ?>"><i class="bi-arrow-return-left" title="Voltar"></i></a>
		    </div>
		</div>
	</div>
	</div>
