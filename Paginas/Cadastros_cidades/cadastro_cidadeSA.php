...
<body>
	...
	<div class="row justify-content-center align-items-center">
		<div class="col-6">
			<form action="../Scripts/Cadastrocidade_script/cadastrocidadeSA_script.php" method="POST">
			...
			<div class="return">
		      <a href="../Cidades/cidadesSA.php?code=<?php echo $_GET['code']; ?>"><i class="bi-arrow-return-left" title="Voltar"></i></a>
		    </div>
		</div>
	</div>
	</div>
