...
<div class="container">
    <div class="row">
        <div class="col">
        <h1 class="pag-tabela">Cidades da Ásia</h1>
        <nav class="navbar">
            <h4>Pesquisar por nome:</h4>
            <div class="container-fluid">
                <form class="d-flex" action="cidadesAs.php<?php echo "?code=$code"; ?>" method="POST">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col">
                <a href="../Cadastros_cidades/cadastro_cidadeAs.php<?php echo "?code=$code"; ?>" class="btn btn-success pull-right">
                            ...
                            while ($linha = mysqli_fetch_assoc($dados)) {
                                ...
                                echo 
                                    "<tr>
                                      ...
                                      <td>$populacao</td>
                                      <td><center>
                                        <a href='../VerMais_cidades/vermais_cidadesAs.php?id=$id' class='mr-3' title='Ver Mais' data-toggle='tooltip'><span class='fa fa-eye'></span></a>
                                        <a href='../Editar_cidades/editar_cidadeAs.php?id=$id&code=$codigopais' class='mr-3' title='Editar Informações' data-toggle='tooltip'><span class='fa fa-pencil'></span></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../Scripts/Excluircidade_script/excluircidadeAs_script.php" method="POST">
