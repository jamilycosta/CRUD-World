...
<body>
	<div class="container">
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-6">
				<form action="../Scripts/Cadastroidioma_script/cadastroidiomaAn_script.php" method="POST">
				...
				<div class="return">
			      <a href="../Idiomas/idiomasAn.php?code=<?php echo $_GET['code']; ?>"><i class="bi-arrow-return-left" title="Voltar"></i></a>
			    </div>
			</div>
		</div>
	</div>
