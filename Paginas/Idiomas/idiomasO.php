...
<div class="container">
    <div class="row">
        <div class="col">
        <h1 class="pag-tabela">Idiomas da Oceania</h1>
        <nav class="navbar">
            <h4>Pesquisar por nome:</h4>
            <div class="container-fluid">
                <form class="d-flex" action="idiomasO.php<?php echo "?code=$code"; ?>" method="POST">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col">
                <a href="../Cadastros_idiomas/cadastro_idiomaO.php<?php echo "?code=$code"; ?>" class="btn btn-success pull-right">
                            ...
                            while ($linha = mysqli_fetch_assoc($dados)) {
                                ...
                                echo 
                                    "<tr>
                                      ...
                                      <td>$porcentagem</td>
                                      <td><center>
                                        <a href='../VerMais_idiomas/vermais_idiomasO.php?linguagem=$linguagem' class='mr-3' title='Ver Mais' data-toggle='tooltip'><span class='fa fa-eye'></span></a>
                                        <a href='../Editar_idiomas/editar_idiomaO.php?linguagem=$linguagem&code=$codigopais' class='mr-3' title='Editar Informações' data-toggle='tooltip'><span class='fa fa-pencil'></span></a>
                ...
                <div class="return">
                    <a href="../Paises/oceania.php"><i class="bi-arrow-return-left" title="Voltar"></i></a>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../Scripts/Excluiridioma_script/excluiridiomaO_script.php" method="POST">
