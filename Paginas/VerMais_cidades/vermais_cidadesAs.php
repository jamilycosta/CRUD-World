    ...
    <div class="row justify-content-center align-items-center">
        <div class="col">
            ...
            <div class="row justify-content-center align-items-center informacoes">
                <div class="col-4">
                    <p class="inform"><?php echo '<b>Id:</b> '.$id = $linha['ID']; ?></p>
                    <p class="inform"><?php echo '<b>Código do País:</b> '.$code = $linha['CountryCode']; ?></p>
                    <p class="inform"><?php echo '<b>Distrito:</b> '.$district = $linha['District']; ?></p>
                    <p class="inform"><?php echo '<b>População:</b> '.$population = $linha['Population']; ?></p>
                </div>
            </div>
            <div class="return">
                <a href="../Cidades/cidadesAs.php<?php echo "?code=$code"; ?>"><i class="bi-arrow-return-left" title="Voltar"></i></a>
            </div>
        </div>
    </div>
</div>
